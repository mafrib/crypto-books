...
(function () {
    const messages = {
        en: {
            ...
            'export.section.loc': 'Authors and number of books per location',
            'export.section.period': 'Authors and number of books per historical period',
            'export.period.header.period'   : 'Historical period',
            'export.period.header.author'   : 'Author',
            'export.period.header.numBooks' : 'No. of books',
        ...
        pt: {
            ...
            'export.section.loc': 'Autores e número de livros por localização',
            'export.section.period': 'Autores e número de livros por época histórica',
            'export.period.header.period'   : 'Época histórica',
            'export.period.header.author'   : 'Autor',
            'export.period.header.numBooks' : 'N.º de livros',
